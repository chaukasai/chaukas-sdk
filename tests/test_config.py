...
def test_config_from_dict():
    ...
    config_dict = {
        ...
        "endpoint": "https://api.chaukas.com",
        "api_key": "test-key",
        "batch_size": 50,
        "flush_interval": 10.0,
        "timeout": 60.0,
    ...
    assert config.endpoint == "https://api.chaukas.com"
...
def test_config_from_env():
    ...
    env_vars = {
        ...
        "CHAUKAS_ENDPOINT": "https://env.chaukas.com",
    ...
    assert config.endpoint == "https://env.chaukas.com"
