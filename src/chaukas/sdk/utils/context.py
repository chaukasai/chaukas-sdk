...
session_id_var: ContextVar[Optional[str]] = ContextVar("chaukas_session_id", default=None)
...
parent_span_id_var: ContextVar[Optional[str]] = ContextVar("chaukas_parent_span_id", default=None)
