...
def main():
    ...
    # Define tasks that will use tools
    research_task = Task(
        description="""Research the topic of 'AI advancements in 2024'.
        Use the search tool to find relevant information.
        Then calculate the percentage growth if AI investment grew from $100B to $150B.""",
    ...
    analysis_task = Task(
        ...
        Use the MCP data fetch tool to get additional context from endpoint '/ai/trends'.
        Calculate the compound annual growth rate if needed.""",
    ...
    print("- INPUT_RECEIVED/OUTPUT_EMITTED")
    print("-" * 50)
    
    # Execute crew - all tool usage will be traced
    result = crew.kickoff()
