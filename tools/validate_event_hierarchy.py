#!/usr/bin/env python3
"""
Event Hierarchy Validator for Chaukas SDK

Validates JSONL event files generated by Chaukas SDK for hierarchy correctness
and visualizes the event tree structure.

Usage:
    python validate_event_hierarchy.py [file.jsonl]
    python validate_event_hierarchy.py  # Validates all .jsonl files in current directory
"""
...
class EventHierarchyAnalyzer:
    """Validates event hierarchy from Chaukas SDK JSONL output."""
